...
<textarea class="textare" name="description" placeholder="description" name="Text"></textarea><br>
...
<?php echo '<option>'.'<i>'.$r['name'].'</i>'.'</option>' ?>
<?php }
		}
	?>
...
<textarea class="textare" name="description" placeholder="change description" name="Text" ></textarea><br>
